data sasep.out;
   ...
   in_out varchar(270) "msg");
      ...
      if null(pm) then do;
         pm = _new_ pymas();
         resultCode = pm.useModule('model_exec_7b4f6f4c-5cfb-4f36-8a9c-4bdab13f55e0', 1);
         if resultCode then do;
            ...
            revision = pm.publish(pm.getSource(), 'model_exec_7b4f6f4c-5cfb-4f36-8a9c-4bdab13f55e0');
