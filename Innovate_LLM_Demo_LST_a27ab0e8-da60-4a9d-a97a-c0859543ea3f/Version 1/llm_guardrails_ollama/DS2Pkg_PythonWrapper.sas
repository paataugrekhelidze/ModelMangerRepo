...
in_out varchar(4000) "response");
   ...
   if null(pm) then do;
      pm = _new_ pymas();
      resultCode = pm.useModule('model_exec_3d16f8d8-cc79-4c67-812c-35c2b52f162b', 1);
      if resultCode then do;
         ...
         resultCode = pm.appendSrcLine('import llm_guardrails_ollama_4cb3a7ed_88e3_488f_ac0e_744d5ca9b5a4');
         ...
         resultCode = pm.appendSrcLine('    return llm_guardrails_ollama_4cb3a7ed_88e3_488f_ac0e_744d5ca9b5a4.scoreModel(prompt, system, history, model, embedder, collection, host, model_port, vector_port)');

         revision = pm.publish(pm.getSource(), 'model_exec_3d16f8d8-cc79-4c67-812c-35c2b52f162b');
