...
"DELINQ", double "DEROG", char(7) "JOB", double "MORTDUE", double "NINQ", 
char(7) "REASON", double "YOJ", in_out double "_leaf_id_", in_out char(12) 
"EM_CLASSIFICATION", in_out double "EM_EVENTPROBABILITY", in_out double 
"EM_PROBABILITY", in_out char(12) "I_BAD", in_out double "IMP_CLAGE", 
in_out double "IMP_DEBTINC", in_out double "IMP_DELINQ", in_out double 
"IMP_DEROG", in_out char(7) "IMP_JOB", in_out double "IMP_NINQ", in_out 
char(7) "IMP_REASON", in_out double "IMP_YOJ", in_out double "P_BAD0", 
