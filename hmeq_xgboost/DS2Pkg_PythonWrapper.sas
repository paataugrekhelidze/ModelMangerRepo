...
in_out varchar(270) "msg");
   ...
   if null(pm) then do;
      pm = _new_ pymas();
      resultCode = pm.useModule('model_exec_93f6c6d5-4231-4244-9f4a-c5576ff386da', 1);
      if resultCode then do;
         ...
         resultCode = pm.appendSrcLine('import hmeq_xgboost_d631db0e_8a10_4701_9a46_b0542f7f3e37');
         ...
         resultCode = pm.appendSrcLine('    return hmeq_xgboost_d631db0e_8a10_4701_9a46_b0542f7f3e37.scoreModel(LOAN, MORTDUE, VALUE, REASON, JOB, YOJ, DEROG, DELINQ, CLAGE, NINQ, CLNO, DEBTINC)');

         revision = pm.publish(pm.getSource(), 'model_exec_93f6c6d5-4231-4244-9f4a-c5576ff386da');
