...
in_out varchar(270) "msg");
   ...
   if null(pm) then do;
      pm = _new_ pymas();
      resultCode = pm.useModule('model_exec_38cc7f4b-ecd2-4408-94ee-bddd7cdceee2', 1);
      if resultCode then do;
         ...
         resultCode = pm.appendSrcLine('import hmeq_xgboost_745cf27e_366b_4fa8_9545_84b83efcd8ed');
         ...
         resultCode = pm.appendSrcLine('    return hmeq_xgboost_745cf27e_366b_4fa8_9545_84b83efcd8ed.scoreModel(LOAN, MORTDUE, VALUE, REASON, JOB, YOJ, DEROG, DELINQ, CLAGE, NINQ, CLNO, DEBTINC)');

         revision = pm.publish(pm.getSource(), 'model_exec_38cc7f4b-ecd2-4408-94ee-bddd7cdceee2');
