...
in_out varchar(270) "msg");
   ...
   if null(pm) then do;
      pm = _new_ pymas();
      resultCode = pm.useModule('model_exec_7fff49dc-57e7-49b6-b38a-9770be95d319', 1);
      if resultCode then do;
         ...
         resultCode = pm.appendSrcLine('import hmeq_xgboost_1b9660ab_4341_4427_b74a_599c99538c19');
         ...
         resultCode = pm.appendSrcLine('    return hmeq_xgboost_1b9660ab_4341_4427_b74a_599c99538c19.scoreModel(LOAN, MORTDUE, VALUE, REASON, JOB, YOJ, DEROG, DELINQ, CLAGE, NINQ, CLNO, DEBTINC)');

         revision = pm.publish(pm.getSource(), 'model_exec_7fff49dc-57e7-49b6-b38a-9770be95d319');
