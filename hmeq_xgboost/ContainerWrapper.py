...
for i, row in input_df.iterrows():
    rowResult.append(hmeq_xgboost.scoreModel(row['LOAN'],row['MORTDUE'],row['VALUE'],row['REASON'],row['JOB'],row['YOJ'],row['DEROG'],row['DELINQ'],row['CLAGE'],row['NINQ'],row['CLNO'],row['DEBTINC']))
output_df = pd.DataFrame(rowResult, columns=['P_Bad1', 'msg'])
