...
%let local_astore_file_path = "{local_astore_file_path}/{concepts model.astore file}";
...
%let input_astore_name = "Concepts_Astore";
...
%let output_table_name = "out_concept_astore_results";
